export const ALL_MISSIONS = {
  ...
  weekly: [
    ...
    { id: 'w2', title: "เสาร์-อาทิตย์ เดินรวมกัน 15,000 ก้าว", reward: 80, goal: 15000, unit: 'ก้าว' },
    { id: 'w3', title: "บันทึก Calorie ต่อเนื่อง 5 วัน", reward: 80, goal: 5, unit: 'วัน' },
    { id: 'w4', title: "ดื่มน้ำครบตามเป้าหมาย 7 วันติดกัน", reward: 100, goal: 7, unit: 'วัน' },
    { id: 'w5', title: "สะสมก้าวย่างรวมครบ 35,000 ก้าว/สัปดาห์", reward: 100, goal: 35000, unit: 'ก้าว' },
  ],
  monthly: [
    { id: 'm1', title: "สะสมก้าวเดินครบ 50,000 ก้าว", reward: 150, goal: 50000, unit: 'ก้าว' },
    { id: 'm2', title: "มีวันที่มีความสุข (Happy Mood) > 15 วัน", reward: 400, goal: 15, unit: 'วัน' },
